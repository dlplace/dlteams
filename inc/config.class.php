...
class PluginDlteamsConfig extends CommonDBTM
{
    ...
    if ($activ_profil == 4) {
        ...
        echo "</tr>";
			...
			echo "<tr class='tab_bg_1'>";
				...
				if ($rgpdmodel_id <> 0 && $mandatory_sites == 0) {
					echo "<form method='post' action='./import_allrgpd_model.php'><input type='submit' name='migrate' value=\"" . __("Import ou MAJ des tables RGPD", 'dlteams') . "\" class='submit'>";
					Html::closeForm();
				}
			echo "</tr>";
        ...
        // permet l'affichage de l'onglet impact ?
