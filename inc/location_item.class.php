...
class PluginDlteamsLocation_Item extends CommonDBTM
{
    static public $itemtype_2 = Location::class;
...
//    {
//        return 'glpi_plugin_dlteams_locations_items'; // TODO: Change the autogenerated stub
//    }
    ...
    {
        return __("Lieux", 'dlteams');
    }

    static function getTypeNameForClass($nb = 0)
    {
        return __("Accès", 'dlteams');
    }
...
//                    }
     ...
     *
     */
    public static function showItems(Location $object_item)
    {
        global $DB;
...
//        Enlève le choix de L'objet LegalBasi dans la dropdown qui affiche la liste des objets
        ...
        if ($canedit) {
            ...
            $types = [PluginDlteamsAccessOpening::class];
...
//
        global $DB;
        $table_item_name = 'glpi_plugin_dlteams_locations_items';
