...
class PluginDlteamsActivitycategory_Item extends CommonDBRelation
{

    public static $itemtype_1 = "PluginDlteamsActivitycategory";
    public static $items_id_1 = 'activitycategories_id ';
