...
class PluginDlteamsActivitycategory_Item extends CommonDBTM
{

    static public $itemtype_2 = 'PluginDlteamsActivitycategory';
    ...
    public function __construct()
    {
        ...
        static::$items_id_1 = "activitycategories_id";
        static::$title = __("Catégories d'activité", 'dlteams');
        static::$sub_title = __("Choisir une nouvelle catégorie d'activité", 'dlteams');
    ...
    {
        return __("Catégories d'activité", 'dlteams');
    }
...
//        var_dump(self::getTable());
    ...
    static function showForItem(CommonDBTM $item, $withtemplate = 0)
    {
        ...
        $canedit = true; // TODO check why can not update
...
//        purge relations
    ...
    public static function getRequest(CommonDBTM $item)
    {
        ...
        $columnid_name = "activitycategories_id";
