...
class PluginDlteamsPersonalDataCategory_onglet_ext extends CommonDBTM {
   ...
   static function getTypeName($nb = 0) {
      return _n('Traitement External', 'Traitement External', $nb);
   }
 ...
 public static function countForItem($item) {
      $dbu = new DbUtils();
      $count = 0;
         $count += $dbu->countElementsInTable('glpi_plugin_dlteams_records_externals', ['plugin_dlteams_concernedpersons_id' => $item->getID()]);
      return $count;
   }
