...
class PluginDlteamsDatacatalog_Directory extends CommonDBTM
{
    ...
    public function __construct()
    {
        ...
        static::$title = __("Est annuaire de", 'dlteams');
        static::$sub_title = __("Catalogues utilisant ce service d’annuaire", 'dlteams');
        static::$table_match_str = [
            [
                'head_text' => __("Catalogue"),
                'column_name' => 'name',
                'show_as_link' => true
            ],
//            [
//                'head_text' => __("Désignation"),
//                'column_name' => 'content',
//            ],
            [
    ...
    {
        return __("Est annuaire de", 'dlteams');
    }
...
//
        ...
        if ($iterator) {
            ...
            if ($canedit && $number) {
                Html::openMassiveActionsForm('mass' . $ma_processor = PluginDlteamsDataCatalog_Otherdirectory_Ma::class . $rand);
                $massive_action_params = [
                    'container' => 'mass' . PluginDlteamsDataCatalog_Otherdirectory_Ma::class . $rand,
            ...
            if ($canedit && $number) {
                ...
                $header_top .= Html::getCheckAllAsCheckbox('mass' . PluginDlteamsDataCatalog_Otherdirectory_Ma::class . $rand);
...
//
//                    if ($key === 0)
//                        $name = "<a target='_blank' href=\"" . static::$itemtype_2::getFormURLWithID($data["datacatalogs_id"]) . "\">" . $name . "</a>";
//
    ...
    public static function getRequest(CommonDBTM $item)
    {
        ...
        $query = [
            'SELECT' => [
                ...
                PluginDlteamsDataCatalog_Item::getTable().'.id as id',
                ...
                PluginDlteamsDataCatalog_Item::getTable().'.datacatalogs_id as datacatalogs_id',
            ...
            'JOIN' => [
                PluginDlteamsDataCatalog::getTable() => [
                    'FKEY' => [
                        PluginDlteamsDataCatalog_Item::getTable() => 'datacatalogs_id',
                        PluginDlteamsDataCatalog::getTable() => 'id'
                    ]
                ]
            ],
            'WHERE' => [
                PluginDlteamsDataCatalog_Item::getTable().'.items_id' => $item->fields['id'],
                PluginDlteamsDataCatalog_Item::getTable().'.itemtype' => PluginDlteamsDataCatalog::class,
                PluginDlteamsDataCatalog_Item::getTable().'.is_directory' => 1,
            ],
            'ORDER' => ['name ASC'],
        ];
