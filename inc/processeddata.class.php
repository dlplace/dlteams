...
class PluginDlteamsProcessedData extends CommonDropdown implements
...
//      echo "<td width='15%' style='text-align:right'>". " " . "</td>";
   ...
   public function copy1($entity, $id, $item){
	  ...
	  if($nb<=0){
		  $DB->request("INSERT INTO ".static::getTable()." (entities_id, is_recursive, is_deleted, is_template, template_name, name, content, comment, rgpd_sensitive_data, seen_sensitive_data, date_mod, date_creation) SELECT '$entity', is_recursive, is_deleted, is_template, template_name, name, content, comment, rgpd_sensitive_data, seen_sensitive_data, date_mod, date_creation FROM ".static::getTable()." WHERE id='$id'");
		  return true;
	  }else{
		  return false;
	  }
