...
class PluginDlteamsKnowbaseItem extends CommonDropdown {
   ...
   public static function getTypeName($nb = 0) {
      return _n('Know Bases', 'Know Base', $nb, 'dlteams');
   }
   ...
   {
       self::forceTable(KnowbaseItem::getTable());
   }

   public static function getTable($classname = null)
   {
       return KnowbaseItem::getTable();
   }
