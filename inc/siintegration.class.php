...
class PluginDlteamsSIIntegration extends CommonDropdown {
   static $rightname = 'plugin_dlteams_siintegration';
   public $dohistory = true;
   protected $usenotepad = true;
  
   static function getTypeName($nb = 0) {
      return _n("SI Integration", "SI Integration", $nb, 'dlteams');
   }
   ...
   function cleanDBonPurge() {
      ...
      $rel->deleteByCriteria(['plugin_dlteams_siintegrations_id' => $this->fields['id']]);
   }
