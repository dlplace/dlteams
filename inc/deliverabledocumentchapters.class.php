...
class PluginDlteamsDeliverableDocumentChapters extends CommonDBTM
{
    ...
    public function getTabNameForItem(CommonGLPI $item, $withtemplate = 0)
    {
        ...
        switch ($item->getType()) {
            case 'PluginDlteamsDeliverable':
                ...
                global $DB;
                $allchapter = $DB->request(PluginDlteamsDeliverableDocumentChapters::getTable(), ['ORDER' => ['timeline_position ASC'], 'deliverables_id' => $item->fields["id"]]);
    ...
    {
        global $DB;
        $allchapter = $DB->request(PluginDlteamsDeliverableDocumentChapters::getTable(), ['ORDER' => ['timeline_position DESC'], 'deliverables_id' => $item->fields["id"]]);
