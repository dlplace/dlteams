 ...
 * Ticket Class
 **/
class PluginDlteamsTicket extends CommonITILObject
{
    // From CommonDBTM
    ...
    {
        self::forceTable(Ticket::getTable());
    }
...
//
            ...
            echo "<tr class='tab_bg_2'><th colspan='3'>" . "Ticket" .
                "</th>";
            echo "</tr>";

            echo "<tr class='tab_bg_1'>";
            echo "<td class='right' style='text-wrap: nowrap;' width='20%'>";
            echo "Ticket existant pour cet élément";
            echo "</td>";
...
//    add by me
    public static function getCommonCriteria()
    {
        ...
        if (self::getType() == PluginDlteamsTicket::class) {
