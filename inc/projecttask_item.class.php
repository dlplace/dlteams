...
class PluginDlteamsProjectTask_Item extends CommonDBTM
{
    static public $itemtype_2 = ProjectTask::class;
    ...
    public function __construct()
    {
        ...
        static::$title = __("Tâches de projets de cet élément", 'dlteams');
        static::$sub_title = __("Choisir une tâche de projet", 'dlteams');
    ...
    {
        return __("Tâches de projets", 'dlteams');
    }
...
//        purge relations
        ...
        if($relation_item_str == "Problem_Item")
            $relation_item_str = Item_Problem::class;
    ...
    public function post_updateItem($history = 1)
    {
        ...
        if($DB->FieldExists($relation_item->getTable(), 'comment')){
            $criteriatoadd["comment"] = $this->oldvalues["comment"];
        }
        $relation_item->add($criteriatoadd);
    }
    ...
    {
        $table_name = ProjectTask::getTable();
        $columnid_name = strtolower(str_replace("PluginDlteams", "", static::$itemtype_2::getType())) . "s_id";

//
        global $DB;
        $table_item_name = "glpi_plugin_dlteams_projecttasks_items";
