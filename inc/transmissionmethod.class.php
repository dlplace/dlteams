...
class PluginDlteamsTransmissionMethod extends CommonDropdown {
   static $rightname = 'plugin_dlteams_transmissionmethod';
   public $dohistory = true;
   protected $usenotepad = true;
  
   static function getTypeName($nb = 0) {
      return _n("Transmission method", "Transmission method", $nb, 'dlteams');
   }
   ...
   function cleanDBonPurge() {
      ...
      $rel->deleteByCriteria(['plugin_dlteams_transmissionmethods_id' => $this->fields['id']]);
   }
