...
class PluginDlteamsProcedureSections extends CommonDBTM
{
    ...
    public function getTabNameForItem(CommonGLPI $item, $withtemplate = 0)
    {
        ...
        switch ($item->getType()) {
            case 'PluginDlteamsProcedure':
                global $DB;
                $allchapter = $DB->request(PluginDlteamsProcedureSections::getTable(), ['ORDER' => ['timeline_position ASC'], 'procedures_id' => $item->fields["id"]]);
    ...
    {
        global $DB;
        $allchapter = $DB->request(PluginDlteamsProcedureSections::getTable(), ['ORDER' => ['timeline_position DESC'], 'procedures_id' => $item->fields["id"]]);
