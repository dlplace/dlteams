...
class PluginDlteamsProjectTask extends CommonDBChild implements CalDAVCompatibleItemInterface
{
   ...
   {
       self::forceTable(ProjectTask::getTable());
   }
    ...
    public static function showFor($item)
    {
        ...
        if (isset($_GET["sort"]) && !empty($_GET["sort"]) && isset($columns[$_GET["sort"]])) {
            ...
            $sort = ["name $order", "plan_start_date"];
            $ui_sort = 'name';
        }
