...
class PluginDlteamsMediaSupport extends CommonDropdown {
   static $rightname = 'plugin_dlteams_mediasupport';
   public $dohistory = true;
   protected $usenotepad = true;
  
   static function getTypeName($nb = 0) {
      return _n("Medias support", "Media support", $nb, 'dlteams');
   }
   ...
   function cleanDBonPurge() {
      ...
      $rel->deleteByCriteria(['plugin_dlteams_mediasupports_id' => $this->fields['id']]);
   }
