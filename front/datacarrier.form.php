...
//die();
$record = new PluginDlteamsDataCarrier();
if (isset($_POST['add'])) {
...
//   );
   ...
   $DB->updateOrDie(
      'glpi_plugin_dlteams_datacarriers',
      [
         //'plugin_dlteams_datacarriertypes_id' => json_encode($_POST['plugin_dlteams_databasetypes_id']),
		 'plugin_dlteams_datacarriertypes_id' => $_POST['plugin_dlteams_databasetypes_id'],
      ],
      ['id' => $_POST['id']]
   );
   $record->redirectToList();
   ...
   if (Session::getCurrentInterface() == 'central') {
     Html::header(PluginDlteamsDataCarrier::getTypeName(2), '', 'dlteams', 'plugindlteamsmenu', 'datacarrier');
   } else {
      Html::helpHeader(PluginDlteamsDataCarrier::getTypeName(0));
   }
