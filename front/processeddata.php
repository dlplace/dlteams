...
if (Session::getCurrentInterface() == 'central') {
   Html::header(PluginDlteamsProcessedData::getTypeName(2), '', 'dlteams', 'plugindlteamsmenu', 'processeddata');
  // Html::header(PluginDlteamsProcessedData::getTypeName(2));
} else {
   Html::helpHeader(PluginDlteamsProcessedData::getTypeName(2));
}
...
//check for ACLs
if (PluginDlteamsProcessedData::canView()) {
  ...
  /* Html::header(
   ...
   Search::show('PluginDlteamsProcessedData');
