...
if (isset($_POST["send_notification"])) {
    ...
    if ($deliverable) {
        $data = [
            "subject" => $deliverable->fields["object_notification"],
            "content_html" =>  html_entity_decode($deliverable->fields["text_notification"]),
...
elseif (isset($_POST["send_approval"])) {
    ...
    if ($deliverable) {
        $approbation_content_html = html_entity_decode($deliverable->fields["text_approval"])."<br/>".$approbation_button . $approbation_text;
        $data = [
