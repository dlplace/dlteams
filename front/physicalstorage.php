...
Html::header(PluginDlteamsPhysicalStorage::getTypeName(2), '', "actifs","plugindlteamsphysicalstorage");
...
//check for ACLs
if (PluginDlteamsPhysicalStorage::canView()) {
   //View is granted: display the list.
   Search::show('PluginDlteamsPhysicalStorage');
   Html::footer();
} else {
   //View is not granted.
