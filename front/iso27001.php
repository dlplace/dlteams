...
if (!isset($_GET['id']) ) {
  ...
  // echo "</table>";
   ...
   Html::header(__("ISO 27001", "genericobject"), $_SERVER['PHP_SELF'], "dlteams", "plugindlteamsiso27001");
   ...
   echo "<table class='tab_cadre_fixe'>";
	...
	echo "<tr class='tab_bg_1'><td align='center' style='text-align:center'>";
        ...
        echo __("Registre des activités", 'dlteams');
    echo "</a></td></tr>";
    /* echo "<tr class='tab_bg_1'><td align='center' style='text-align:center'>";
	...
	echo "</a></td></tr>";
	echo "<tr class='tab_bg_1'><td align='center' style='text-align:center'>";
        echo "<a target='_blank' href='". Appliance::getSearchURL()."'>";
