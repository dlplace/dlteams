...
if (Session::getCurrentInterface() == 'central') {
   Html::header(PluginDlteamsApplication::getTypeName(2), '', 'dlteams', 'PluginDlteamsmenu', 'application');
  
} else {
   Html::helpHeader(PluginDlteamsApplication::getTypeName(2));
}
...
//check for ACLs
if (PluginDlteamsApplication::canView()) {
  ...
  /* Html::header(
   ...
   Search::show('PluginDlteamsApplication');
