...
$record = new PluginDlteamsAccessOpening();
...
if (isset($_POST['add'])) {
    ...
    if (Session::getCurrentInterface() == 'central') {
        Html::header(PluginDlteamsAccessOpening::getTypeName(2), '', "actifs","plugindlteamsaccessopening");
    } else {
        Html::helpHeader(PluginDlteamsAccessOpening::getTypeName(0));
    }
