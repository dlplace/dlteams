...
if (Session::getCurrentInterface() == 'central') {
  Html::header(PluginDlteamsStoragePeriod::getTypeName(2), '', 'dlteams', 'plugindlteamsmenu', 'storageperiod');
} else {
   Html::helpHeader(PluginDlteamsStoragePeriod::getTypeName(2));
}
...
//check for ACLs
if (PluginDlteamsStoragePeriod::canView()) {
  ...
  /* Html::header(
   ...
   Search::show('PluginDlteamsStoragePeriod');
