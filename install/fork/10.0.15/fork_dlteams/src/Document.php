...
//        TODO: dlregister
        ...
        PluginDlteamsDeliverable::dropdown([
            ...
            'value' => $this->fields["deliverables_id"], //$responsible,
        ...
        if($this->fields["deliverables_id"]){
            ...
            $url = Toolbox::getItemTypeFormURL("PluginDlteamsDeliverable")
                ."?deliverable_id=".$this->fields["deliverables_id"]."&report_type="
...
//        echo "<a href='#' target='_blank'><i class='fa fa-external-link'></i></a>";
        echo "</div>";
        echo "</td></tr>";
