    ...
    public function updateInDB($updates, $oldvalues = [])
    {
        ...
        foreach ($updates as $field) {
            if (array_key_exists($field, $this->fields)) {
                ...
                //TODO dlteams
                $toescape_array = [Group::getTable()];
                if (in_array($this->getTable(), $toescape_array))
                    $tobeupdated[$field] = $DB->escape($this->fields[$field]);
                else
...
//                end bloc dlteams
     ...
     * If you want to work on search options, @return array an *indexed* array of search options
     *
     * @see CommonDBTM::rawSearchOptions
     *
...
//            TODO Dlregister: addslashes() added to escape \
