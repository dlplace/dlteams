...
if (isset($_POST["add"])) {
    ...
    if (isset($_POST["projecttasks_id"]) && $_POST["projecttasks_id"]) {
        $projecttask_parent = new ProjectTask();

        $projecttask_parent->getFromDB($_POST["projecttasks_id"]);

        $data["completename"] = $projecttask_parent->fields["name"] . " > " . addslashes($_POST["name"]);
    }
