...
//            todo dlregister
                $ticket = new Ticket();
                $ticket->getFromDB($params['parentid']);
                echo "<a href='" . $params['url'] . "' target='_blank' class='btn btn-outline-secondary'>" .
                    "<i class='ti ti-eye'></i>" .
                    "<span>" . __(sprintf("Cette tâche fait partie de l'événement n°%s ", $ticket->fields["id"])) . "</span>" .
