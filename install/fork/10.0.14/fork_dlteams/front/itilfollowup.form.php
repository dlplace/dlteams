...
//TODO: dlteams
if(isset($_GET["id"])){
    $fp = new PluginDlteamsITILFollowup();
    if (Session::getCurrentInterface() == 'central') {
        Html::header(PluginDlteamsITILFollowup::getTypeName(2), '', 'dlteams', 'plugindlteamsmenu', 'itilfollowup');
    } else {
        Html::helpHeader(PluginDlteamsITILFollowup::getTypeName(0));
    }
    $fp->display(['id' => $_GET["id"]]);
    return true;
}
