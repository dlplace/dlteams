...
JAVASCRIPT;
    ...
    public function getTimelineItems(array $options = [])
    {
        ...
        if (!$params['check_view_rights'] || $task_obj->canview()) {
            ...
            $restrict_task['tickettasks_id'] = NULL;
    ...
    public function getTimelineStats(): array
    {
        ...
        if ($row = $req->current()) {
            ...
            $stats['total_estimate_duration'] = $row['estimate_duration'];
        }
        ...
        $stats['nb_planifications'] = $result['cpt'];
