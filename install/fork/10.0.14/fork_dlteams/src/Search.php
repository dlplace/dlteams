...
//                todo dlteams
            case 'PluginDlteamsTicketTask':
                ...
                $condition .= ") AND `glpi_tickets`.`entities_id` in ('".implode("','",$_SESSION['glpiactiveentities'])."')";
            ...
            case 'PluginDlteamsStep':
                ...
                if(!$projects_id)
                    $condition.=" `glpi_projects`.`name` = 'Référentiel RGPD' ";
                break;
