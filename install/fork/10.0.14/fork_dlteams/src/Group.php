...
class Group extends CommonTreeDropdown
{
    ...
    public function showForm($ID, array $options = [])
    {
        ...
        echo "<td>" . "Acronyme" . "</td><td>";
        echo Html::input('acronym', ['value' => $this->fields['acronym']]);
        echo "</td></tr>";
        ...
        echo Html::input('phonenumber', ['value' => $this->fields['phonenumber']]);
        echo "</td></tr>";
        ...
        echo "<tr class='tab_bg_1'>";
        echo "<td>" . Location::getTypeName(Session::getPluralNumber()) . "</td><td>";
