               ...
               // Manage translations
                ...
                if ($output_type == Search::HTML_OUTPUT) {
					...
					echo Search::showItem(
                        ...
                        "<div class='kb'>$toadd <i class='fa fa-fw $fa_class' title='$fa_title'></i> <a $href>" . Html::resume_text($name, 80) . "</a></div>
                                       <div class='kb_resume'>" .  "Article " .$data["id"] . " - " . Html::resume_text(RichText::getTextFromHtml($answer, false, false, true), 600) . "</div>",
                        $item_num,
                        $row_num
                    );
                } else {
                ...
                foreach ($categories as $category) {
                    ...
                    if ($output_type == Search::HTML_OUTPUT) {
                        ...
                        $categories_names[] = "<div style='text-align: left;'>"."<a class='tab_bg_1'"
                            . " href='$cathref'"
