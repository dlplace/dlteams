...
ALTER TABLE `glpi_plugin_dlteams_storageperiods` CHANGE `url` `url` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL;
ALTER TABLE `glpi_plugin_dlteams_storageperiods` CHANGE `url2` `url2` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL;
...
ALTER TABLE `glpi_plugin_dlteams_storageperiods` 
	CHANGE IF EXISTS `url` `url` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL;
ALTER TABLE `glpi_plugin_dlteams_storageperiods` 
	CHANGE IF EXISTS `url2` `url2` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL;
...
ALTER TABLE `glpi_plugin_dlteams_deliverables`
    CHANGE IF EXISTS `text_notification` `text_notification` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL;

ALTER TABLE `glpi_plugin_dlteams_deliverables`
    CHANGE IF EXISTS `text_approval` `text_approval` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL;
...
) ENGINE=InnoDB AUTO_INCREMENT=1000 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='PluginDlteamsAccountKey';
...
ALTER TABLE `glpi_plugin_dlteams_deliverables_items`
    CHANGE `comment` `comment` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL;

ALTER TABLE `glpi_plugin_dlteams_users_items`
    CHANGE `comment` `comment` LONGTEXT CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL;
ALTER TABLE `glpi_plugin_dlteams_contacts_items`
    CHANGE `comment` `comment` LONGTEXT CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL;

#01/08/2023 10:11GMT
ALTER TABLE `glpi_plugin_dlteams_deliverables_items`
    CHANGE `object_notification` `object_notification` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL;
ALTER TABLE `glpi_plugin_dlteams_deliverables_items`
    CHANGE `object_approval` `object_approval` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL;
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_dlteams_trainingsessions` (
 ...
 KEY `date_mod` (`date_mod`),
 KEY `date_creation` (`date_creation`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='PluginDlteamsTrainingSession';
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_dlteams_physicalstorages` (
 ...
 `is_helpdesk_visible` TINYINT(1) NOT NULL DEFAULT 0,
 PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='PluginDlteamsPhysicalStorage';
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_dlteams_deliverablevariables` (
 ...
 `is_helpdesk_visible` TINYINT(1) NOT NULL DEFAULT 0,
 PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='PluginDlteamsDeliverableVariable';
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_dlteams_mediasupports` (
 ...
 `is_helpdesk_visible` TINYINT(1) NOT NULL DEFAULT 0,
 PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='PluginDlteamsMediaSupport';
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_dlteams_siintegrations` (
 ...
 `is_helpdesk_visible` TINYINT(1) NOT NULL DEFAULT 0,
 PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='PluginDlteamsSIIntegration';
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_dlteams_transmissionmethods` (
 ...
 `is_helpdesk_visible` TINYINT(1) NOT NULL DEFAULT 0,
 PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='PluginDlteamsTransmissionMethod';
