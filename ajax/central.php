...
switch ($_REQUEST['widget']) {
    case 'central_count':
        ...
        break;
    case 'central_list':
        if($itemtype == PluginDlteamsMessagerie::class)
            $itemtype::showCentralList();
        elseif($itemtype == TicketValidation::class)
            PluginDlteamsCentral::showCentralListForTicketValidation();
        elseif (method_exists($itemtype, 'showCentralList')) {
